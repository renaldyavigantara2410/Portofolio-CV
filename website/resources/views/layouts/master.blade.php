...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Siskupala</title>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.js" type="module" defer></script>
        <!-- BEGIN: CSS Assets-->
    ...
    <body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
        ...
        <script src="https://cdn.datatables.net/responsive/2.5.0/js/responsive.jqueryui.min.js"></script>
        @stack('scripts')
        <!-- END: JS Assets-->
    </body>
</html>
